...
export default memo(
  forwardRef<GamesTableHandle, Props>(function GamesTable(
    { games, platformMap, onDelete, selecting, selected, onToggleSelect, sortBy, onSort, columns },
    ref
  ) {
    ...
    useImperativeHandle(ref, () => ({
      scrollToIndex: (index: number) => rowVirtualizer.scrollToIndex(index, { align: 'start' }),
    }))
          ...
          <table style={{ tableLayout: 'fixed', width: '100%' }}>
            <colgroup>
              ...
              {visibleCols.map((col) => {
                ...
                return <col key={col.key} style={{ width: widths[col.key] }} />
              })}
              {!selecting && <col style={{ width: 80 }} />}
            </colgroup>
            <thead>
              <tr>
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ fontWeight: 500 }}>
                      ...
                      {!game.monitored && (
                        <span className="text-muted text-sm"> (unmonitored)</span>
                      )}
                    </td>
                    {visibleCols.map((col) => (
